...
if config.expt_type == ExperimentTypes.TRACE_PREDICTION:
    real_paths  = ["/home/justinyu/vsumedh/data/raw_images/"]
...
if expt_type == ExperimentTypes.TRACE_PREDICTION and trace_full_cable:
    if not real_world_trace:
        ...
        # even_more_real_world = '/home/justinyu/vsumedh/data/raw_images'
    ...
    for i, image in enumerate(images):
        if not real_world_trace:
            ...
            if image.endswith('.npy'):
                ...
                if 'real_data_for_tracer' in image: # image has now been changed
                    img = img.item()['img'][:, :, :3]
            else:
